...
$$
\frac{d\left(x,z\right)+d\left(z,y\right)}{1+d\left(x,z\right)+d\left(z,y\right)}\le\frac{d\left(x,z\right)}{1+d\left(x,z\right)}+\frac{d\left(z,y\right)}{1+d\left(z,y\right)}
$$
...
$$
\ln\left(1+d\left(x,z\right)+d\left(z,y\right)\right)\le\ln\left(1+d\left(x,z\right)\right)+\ln\left(1+d\left(z,y\right)\right)
$$
