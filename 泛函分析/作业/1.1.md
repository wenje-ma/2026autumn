...
综上，三种度量下的收敛性是等价的。$\quad\boxed{\sigma_\omega\sigma}$
...
故 $d_1,d_2$ 都是 $X$ 上的度量。$\quad\boxed{\sigma_\omega\sigma}$
...
这正是 $\left\{P_k\right\}$ 在 $\left[0,1\right]$ 上一致收敛于多项式 $P$ 的定义，两者等价。$\quad\boxed{\sigma_\omega\sigma}$
...
$$
\left(a+b\right)^p=b^p\left(1+\frac{a}{b}\right)^p\le b^p\left[1+\left(\frac{a}{b}\right)^p\right]=a^p+b^p\quad\boxed{\sigma_\omega\sigma}
$$
...
积分即得 $d\left(f,g\right)\le d\left(f,h\right)+d\left(h,g\right)$。故 $d$ 是伪度量。$\quad\boxed{\sigma_\omega\sigma}$
...
故在等价类空间 $L^p\left[0,1\right]/\sim$ 上，$d\left(\left[f\right],\left[g\right]\right)=0\Leftrightarrow\left[f\right]=\left[g\right]$，因此 $\left(L^p\left[0,1\right]/\sim,d\right)$ 是度量空间。$\quad\boxed{\sigma_\omega\sigma}$
...
$$
d\left(\left(1,0,0\right),\left(x_1,x_2,0\right)\right)=\arccos x_1=\arcsin x_2\quad\boxed{\sigma_\omega\sigma}
$$
...
合并即得 $\rho\left(x,y\right)\le d\left(x,y\right)\le\frac{\pi}{2}\rho\left(x,y\right)$。$\quad\boxed{\sigma_\omega\sigma}$
...
由于 $\gamma,\alpha+\beta\in\left[0,\pi\right]$ 且 $\cos$ 在 $\left[0,\pi\right]$ 上严格递减，得 $\gamma\le\alpha+\beta$。故三角不等式成立，$d$ 是 $S^2$ 上的度量。$\quad\boxed{\sigma_\omega\sigma}$
